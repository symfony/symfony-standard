...
check(version_compare(phpversion(), '5.3.3', '>='), sprintf('Checking that PHP version is at least 5.3.3 (%s installed)', phpversion()), 'Install PHP 5.3.1 or newer (current version is '.phpversion(), true);
